...
class KeyImportFragment : Fragment() {
    ...
    private fun importKey() {
        ...
        if (privateKeyContent.isEmpty()) {
            Toast.makeText(context, "Please provide a private key", Toast.LENGTH_SHORT).show()
            return
        }
        
        if (keyName.isEmpty()) {
            Toast.makeText(context, "Please provide a key name", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        lifecycleScope.launch {
            try {
                ...
                Toast.makeText(context, "Key imported successfully", Toast.LENGTH_SHORT).show()
